...
class CrackScopeNet_Seg(nn.Layer):
    ...
    def init_weight(self):
        #assert self.pretrained is not None, "model isn't loading from pretrained!"
...
@manager.MODELS.add_component
def CrackScopeNet_Tiny(num_classes=2):
    return CrackScopeNet_Seg(16, (3,3,4), (16,32,64), num_classes=num_classes, dropout_rate=0.1)

@manager.MODELS.add_component
def CrackScopeNet_Small(num_classes=2):
    return CrackScopeNet_Seg(24, (3,3,4), (24,48,96), num_classes=num_classes, dropout_rate=0.1)

@manager.MODELS.add_component
def CrackScopeNet(num_classes=2):
    return CrackScopeNet_Seg(32, (3,3,4), (32,64,128), num_classes=num_classes, dropout_rate=0.1)

@manager.MODELS.add_component
def CrackScopeNet_Large(num_classes=2):
    return CrackScopeNet_Seg(64, (3,3,3), (64,128,160), dropout_rate=0.1)
